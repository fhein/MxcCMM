...
namespace MxcCommons\Config\Processor;

use MxcCommons\Config\Config;
use MxcCommons\Config\Exception;
use MxcCommons\I18n\Translator\Translator as ZendTranslator;
...
class Translator implements ProcessorInterface
{
    ...
    /**
     * Translator uses the supplied MxcCommons\I18n\Translator\Translator to find
