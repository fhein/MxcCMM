<?php /** @noinspction PhpUnhandledExceptionInspection */
...
namespace MxcCommons\ServiceManager\AbstractFactory;
...
class ReflectionBasedAbstractFactory implements AbstractFactoryInterface
{
     ...
     * <code>
     * [
     *     \MxcCommons\Filter\FilterPluginManager::class       => 'FilterManager',
     *     \MxcCommons\Validator\ValidatorPluginManager::class => 'ValidatorManager',
     * ]
     * </code>
     *
     * @var string[]
