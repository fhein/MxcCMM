...
use ArrayIterator;
use MxcCommons\Http\Header\SetCookie;
use MxcCommons\Uri;

/**
 * A MxcCommons\Http\Cookies object is designed to contain and maintain HTTP cookies, and should
 * be used along with MxcCommons\Http\Client in order to manage cookies across HTTP requests and
 * responses.
 *
 * The class contains an array of MxcCommons\Http\Header\Cookie objects. Cookies can be added
 ...
 * can be returned either in their native form (as MxcCommons\Http\Header\Cookie objects) or as strings -
 ...
 * (by passing MxcCommons\Http\Client\Cookies::COOKIE_STRING_ARRAY) or one unified string for all cookies
 * (by passing MxcCommons\Http\Client\Cookies::COOKIE_STRING_CONCAT).
 *
...
{
    /**
     * Return cookie(s) as a MxcCommons\Http\Cookie object
     */
    ...
    /**
     * Add a cookie to the class. Cookie should be passed either as a MxcCommons\Http\Header\SetCookie object
     ...
     *
     * @param int $retAs Whether to return cookies as objects of \MxcCommons\Http\Header\SetCookie or as strings
     * @return array|string
     */
     ...
     * @param int $retAs Whether to return cookies as objects of \MxcCommons\Http\Header\Cookie or as strings
