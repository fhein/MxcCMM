...
use ArrayIterator;
use MxcCommons\Http\Header\HeaderInterface;
use MxcCommons\Stdlib\Parameters;
use MxcCommons\Stdlib\ParametersInterface;
use MxcCommons\Stdlib\RequestInterface;
use MxcCommons\Uri\Exception as UriException;
use MxcCommons\Uri\Http as HttpUri;
...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /**
     * Set the URI/URL for this request, this can be a string or an instance of MxcCommons\Uri\Http
     *
     * @throws Exception\InvalidArgumentException
    ...
    public function setUri($uri)
    {
        if (is_string($uri)) {
            ...
            throw new Exception\InvalidArgumentException(
                'URI must be an instance of MxcCommons\Uri\Http or a string'
            );
        }
        $this->uri = $uri;
     ...
     * @return \MxcCommons\Http\Headers|bool|HeaderInterface|ArrayIterator
     *@see \MxcCommons\Http\Headers::get()
     */
