...
use Countable;
use Iterator;
use MxcCommons\Http\Header\Exception;
use MxcCommons\Http\Header\GenericHeader;
use MxcCommons\Loader\PluginClassLocator;
use Traversable;
...
class Headers implements Countable, Iterator
{
    ...
    public function get($name)
    {
        ...
        $class = ($this->getPluginClassLoader()->load(str_replace('-', '', $key))) ?: 'MxcCommons\Http\Header\GenericHeader';

        if (in_array('MxcCommons\Http\Header\MultipleHeaderInterface', class_implements($class, true))) {
            $headers = [];
