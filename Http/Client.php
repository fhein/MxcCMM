...
use ArrayIterator;
use MxcCommons\Http\Client\Adapter\Curl;
use MxcCommons\Http\Client\Adapter\Socket;
use MxcCommons\Http\Client\Exception\RuntimeException;
use MxcCommons\Http\Header\SetCookie;
use MxcCommons\Stdlib;
use MxcCommons\Stdlib\ArrayUtils;
use MxcCommons\Stdlib\ErrorHandler;
use MxcCommons\Uri\Http;
use Traversable;
