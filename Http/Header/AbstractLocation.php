...
namespace MxcCommons\Http\Header;

use MxcCommons\Uri\Exception as UriException;
use MxcCommons\Uri\UriFactory;
use MxcCommons\Uri\UriInterface;
...
abstract class AbstractLocation implements HeaderInterface
{
    ...
    /**
     * Set the URI/URL for this header, this can be a string or an instance of MxcCommons\Uri\Http
     *
    ...
    public function setUri($uri)
    {
        if (is_string($uri)) {
            ...
            throw new Exception\InvalidArgumentException('URI must be an instance of MxcCommons\Uri\Http or a string');
        }
        $this->uri = $uri;
    ...
    /**
     * Return the URI for this header as an instance of MxcCommons\Uri\Http
     *
     * @return UriInterface
     */
    public function uri()
