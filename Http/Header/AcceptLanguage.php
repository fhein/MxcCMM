...
use MxcCommons\Http\Header\Accept\FieldValuePart\LanguageFieldValuePart;
...
class AcceptLanguage extends AbstractAccept
{
     ...
     * @see \MxcCommons\Http\Header\AbstractAccept::parseFieldValuePart()
     */
    protected function parseFieldValuePart($fieldValuePart)
    {
        ...
        return new LanguageFieldValuePart((object) $aggregated);
    }
}
