...
use MxcCommons\Log\Formatter\ChromePhp as ChromePhpFormatter;
use MxcCommons\Log\Logger;
use MxcCommons\Log\Writer\ChromePhp\ChromePhpBridge;
use MxcCommons\Log\Writer\ChromePhp\ChromePhpInterface;
use Traversable;
    ...
    public function __construct($instance = null)
    {
        ...
        if (! ($instance instanceof ChromePhpInterface || $instance === null)) {
            throw new Exception\InvalidArgumentException(
                'You must pass a valid MxcCommons\Log\Writer\ChromePhp\ChromePhpInterface'
            );
        }
