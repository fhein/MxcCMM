...
use MxcCommons\Log\Formatter\Db as DbFormatter;
use Traversable;
...
class Db extends AbstractWriter
{
     ...
     * Constructor
     *
     * We used the Adapter instead of MxcCommons\Db for a performance reason.
     *
    ...
    public function __construct($db, $tableName = null, array $columnMap = null, $separator = null)
    {
        ...
        if (! $db instanceof Adapter) {
            throw new Exception\InvalidArgumentException('You must pass a valid MxcCommons\Db\Adapter\Adapter');
        }
