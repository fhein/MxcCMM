...
namespace MxcCommons\Db\Sql\Platform;
...
use MxcCommons\Db\Sql\Exception;
use MxcCommons\Db\Sql\PreparableSqlInterface;
use MxcCommons\Db\Sql\SqlInterface;
...
class Platform extends AbstractPlatform
{
    ...
    public function prepareStatement(AdapterInterface $adapter, StatementContainerInterface $statementContainer)
    {
        if (! $this->subject instanceof PreparableSqlInterface) {
            throw new Exception\RuntimeException(
                'The subject does not appear to implement MxcCommons\Db\Sql\PreparableSqlInterface, thus calling '
    ...
    public function getSqlString(PlatformInterface $adapterPlatform = null)
    {
        if (! $this->subject instanceof SqlInterface) {
            throw new Exception\RuntimeException(
                'The subject does not appear to implement MxcCommons\Db\Sql\SqlInterface, thus calling '
                . 'prepareStatement() has no effect'
            );
        }
    ...
    protected function resolvePlatform($adapterOrPlatform)
    {
        ...
        throw new Exception\InvalidArgumentException(sprintf(
            ...
            'MxcCommons\Db\Adapter\AdapterInterface',
            'MxcCommons\Db\Adapter\Platform\PlatformInterface'
        ));
    }
