...
namespace MxcCommons\Db\Sql\Predicate;

use MxcCommons\Db\Sql\Exception;
use MxcCommons\Db\Sql\Select;
use MxcCommons\Db\Sql\AbstractExpression;
    ...
    public function setValueSet($valueSet)
    {
        if (! is_array($valueSet) && ! $valueSet instanceof Select) {
            throw new Exception\InvalidArgumentException(
                '$valueSet must be either an array or a MxcCommons\Db\Sql\Select object, ' . gettype($valueSet) . ' given'
            );
        }
