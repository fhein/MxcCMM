...
use MxcCommons\Db\Sql\Join;
use MxcCommons\Db\Sql\Select;
use MxcCommons\Db\Sql\Sql;
use MxcCommons\Db\Sql\TableIdentifier;
use MxcCommons\Db\Sql\Update;
use MxcCommons\Db\Sql\Where;
use MxcCommons\Db\TableGateway\Feature\EventFeatureEventsInterface;
...
abstract class AbstractTableGateway implements TableGatewayInterface
{
    ...
    /**
     * @param \MxcCommons\Db\Sql\Update $update
     * @return int
     */
