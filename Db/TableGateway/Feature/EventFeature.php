...
use MxcCommons\Db\Adapter\Driver\ResultInterface;
use MxcCommons\Db\Adapter\Driver\StatementInterface;
use MxcCommons\Db\ResultSet\ResultSetInterface;
use MxcCommons\Db\Sql\Delete;
    ...
    EventsCapableInterface
{
    ...
    public function __construct(
        ...
        $this->eventManager->addIdentifiers([
            'MxcCommons\Db\TableGateway\TableGateway',
        ]);
    ...
    {
        if (get_class($this->tableGateway) != 'MxcCommons\Db\TableGateway\TableGateway') {
