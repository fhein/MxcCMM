...
use MxcCommons\Db\RowGateway\RowGateway;
use MxcCommons\Db\RowGateway\RowGatewayInterface;
    ...
    public function postInitialize()
    {
        ...
        if (! $this->tableGateway->resultSetPrototype instanceof ResultSet) {
            throw new Exception\RuntimeException(
                'This feature ' . __CLASS__ . ' expects the ResultSet to be an instance of MxcCommons\Db\ResultSet\ResultSet'
            );
        }
        ...
        if (isset($args[0])) {
            ...
            $metadata = $this->tableGateway->featureSet->getFeatureByClassName(
                'MxcCommons\Db\TableGateway\Feature\MetadataFeature'
            );
