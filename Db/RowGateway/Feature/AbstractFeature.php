...
namespace MxcCommons\Db\RowGateway\Feature;

use MxcCommons\Db\RowGateway\AbstractRowGateway;
use MxcCommons\Db\RowGateway\Exception;
use MxcCommons\Db\RowGateway\Exception\RuntimeException;
...
abstract class AbstractFeature extends AbstractRowGateway
{
    ...
    {
        throw new RuntimeException('This method is not intended to be called on this object.');
    }
