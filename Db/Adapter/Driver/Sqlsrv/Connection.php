...
namespace MxcCommons\Db\Adapter\Driver\Sqlsrv;

use MxcCommons\Db\Adapter\Driver\AbstractConnection;
use MxcCommons\Db\Adapter\Driver\Sqlsrv\Exception\ErrorException;
...
class Connection extends AbstractConnection
{
    ...
    public function __construct($connectionInfo)
    {
        if (is_array($connectionInfo)) {
            ...
            throw new InvalidArgumentException('$connection must be an array of parameters or a resource');
        }
    }
    ...
    public function setResource($resource)
    {
        if (get_resource_type($resource) !== 'SQL Server Connection') {
            throw new InvalidArgumentException('Resource provided was not of type SQL Server Connection');
        }
