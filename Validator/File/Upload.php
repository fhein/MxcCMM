...
class Upload extends AbstractValidator
{
     ...
     *
     * The array $files must be given in syntax of MxcCommons\File\Transfer\Transfer to be checked
     * If no files are given the $_FILES array will be used automatically.
     * NOTE: This validator will only work with HTTP POST uploads!
     *
     * @param  array|Traversable $options Array of files in syntax of \MxcCommons\File\Transfer\Transfer
     */
     ...
     *
     * @param  array $files The files to check in syntax of \MxcCommons\File\Transfer\Transfer
