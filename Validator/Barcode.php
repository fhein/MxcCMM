...
class Barcode extends AbstractValidator
{
    ...
    protected $options = [
        'adapter'     => null,  // Barcode adapter MxcCommons\Validator\Barcode\AbstractAdapter
    ...
    public function setAdapter($adapter, $options = null)
    {
        if (is_string($adapter)) {
            ...
            $adapter = 'MxcCommons\\Validator\\Barcode\\' . $adapter;
        ...
        if (! $adapter instanceof Barcode\AdapterInterface) {
            throw new Exception\InvalidArgumentException(
                sprintf(
                    "Adapter %s does not implement MxcCommons\\Validator\\Barcode\\AdapterInterface",
    ...
    /**
     * Defined by MxcCommons\Validator\ValidatorInterface
     *
