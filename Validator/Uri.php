...
use Traversable;
use MxcCommons\Uri\Exception\ExceptionInterface as UriException;
use MxcCommons\Uri\Uri as UriHandler;
...
class Uri extends AbstractValidator
{
    ...
    public function getUriHandler()
    {
        ...
        if (! $this->uriHandler instanceof UriHandler) {
            throw new InvalidArgumentException('URI handler is expected to be a MxcCommons\Uri\Uri object');
        }
    ...
    {
        if (! is_subclass_of($uriHandler, 'MxcCommons\Uri\Uri')) {
            throw new InvalidArgumentException('Expecting a subclass name or instance of MxcCommons\Uri\Uri as $uriHandler');
        }
