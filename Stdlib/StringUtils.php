...
namespace MxcCommons\Stdlib;

use MxcCommons\Stdlib\StringWrapper\StringWrapperInterface;
    ...
    public static function getRegisteredWrappers()
    {
        if (static::$wrapperRegistry === null) {
            ...
            if (extension_loaded('intl')) {
                static::$wrapperRegistry[] = 'MxcCommons\Stdlib\StringWrapper\Intl';
            }

            if (extension_loaded('mbstring')) {
                static::$wrapperRegistry[] = 'MxcCommons\Stdlib\StringWrapper\MbString';
            }

            if (extension_loaded('iconv')) {
                static::$wrapperRegistry[] = 'MxcCommons\Stdlib\StringWrapper\Iconv';
            }

            static::$wrapperRegistry[] = 'MxcCommons\Stdlib\StringWrapper\Native';
        }
